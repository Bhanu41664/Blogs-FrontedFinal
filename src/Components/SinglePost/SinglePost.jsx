...
function SinglePost() {
  ...
  const PF=`https://blog-node-backend-shg7.onrender.com/images/`
  ...
  useEffect(()=>{
    const getpost=async ()=>{
      const res=await axios.get(`https://blog-node-backend-shg7.onrender.com/api/posts/${path}`)
      setPost(res.data);
 ...
 const handleDelete = async ()=>{
  try{
    ...
    await axios.delete(`https://blog-node-backend-shg7.onrender.com/api/posts/${post._id}`,{
 ...
 const handleUpdate = async()=>{
  try{
    ...
    await axios.put(`https://blog-node-backend-shg7.onrender.com/api/posts/${post._id}`,{
